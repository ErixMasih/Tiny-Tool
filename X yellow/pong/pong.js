...
function update() {
    ...
    // player1, player2 drawing code remains the same

    // ball
    context.fillStyle = "white";
    context.beginPath(); // Start drawing a path
    context.arc(ball.x, ball.y, ball.radius, 0, 2 * Math.PI); // Draw a circle
    context.fill(); // Fill the circle

    // Ball movement and collision detection code remains the same
